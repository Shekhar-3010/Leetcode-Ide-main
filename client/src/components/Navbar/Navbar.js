	...
	return (
		<div className="ml-2 mt-2 w-full flex h-8 md:h-12 justify-between mb-2">
			<button
				...
				className="bg-[#6dd5ed] border-[#4cae4c] border-1 text-white rounded-full md:p-2 p-1 w-32 text-sm md:text-base hover:border-[#398439] hover:bg-[#449d44] ">
				<FontAwesomeIcon
					icon={faPlayCircle}
					className="mr-2"
					color="white"
